...
<span class="anix-kicker">Кураторская полка</span>
...
|---|---|---|
| [GitLab Onboarding](https://handbook.gitlab.com/handbook/people-group/general-onboarding/) | явные задачи, self-driven путь, отсутствие ожидания «сразу в бой» | проектирование онбординга |
| [GitLab All-Remote Guide](https://handbook.gitlab.com/handbook/company/culture/all-remote/guide/) | written processes и асинхронная передача знаний | объяснить, зачем wiki |
| [Atlassian Knowledge Base](https://www.atlassian.com/software/confluence/resources/guides/best-practices/knowledge-base) | родительские страницы по продуктам и связанная иерархия | улучшать архитектуру wiki |
| [Setting up a knowledge base](https://www.atlassian.com/itsm/knowledge-management/setting-up-a-knowledge-base) | начинать с повторяющихся вопросов и проверять статью чужими руками | приоритизировать новые страницы |

## Визуальное объяснение и обучение
...
| Материал | Что взять | Когда отправить |
|---|---|---|
| [Почему это работает](https://studio.anix-ai.pro/why_it_works/) | краткая публичная evidence-рамка | после разговора о ценности формата |
| [Фарма и MedTech](https://studio.anix-ai.pro/medicine/) | позиционирование и релевантные примеры | фарм / медицинскому клиенту |
| [HSE](https://studio.anix-ai.pro/hse/) | визуальное обучение и safety-коммуникация | HSE / L&D-клиенту |
| [Все кейсы](https://studio.anix-ai.pro/cases/) | публичные кейсы с визуалами | вместо тяжёлого общего портфолио |

## Правило добавления

Для новой ссылки записать:

1. один переносимый тезис;
2. границу применимости;
